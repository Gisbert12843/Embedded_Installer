...
#define INPUTBOX_WIDTH	250 * ASPECT_RATIO_X
#define INPUTBOX_HEIGHT 150 * ASPECT_RATIO_Y
#define TEXTEDIT_HEIGHT	30 * ASPECT_RATIO_Y
#define BUTTON_HEIGHT	30 * ASPECT_RATIO_Y
#define BUTTON_WIDTH	80 * ASPECT_RATIO_X
#define FONT_HEIGHT		20 * ASPECT_RATIO_Y
#define FONT_HEIGHT_TEXTFELD		11 * ASPECT_RATIO_Y

#define CLASSNAME					L"SG_Inputbox"
#define PUSH_BUTTON					L"Button"
#define FONT_NAME					_T("Times")
#define TEXTEDIT_CLASS				L"edit"
#define SetFontToControl(n)			SendMessageW((n), WM_SETFONT, (WPARAM)m_hFont, 0);
#define SetFontToControl_textfield(n)			SendMessageW((n), WM_SETFONT, (WPARAM)m_hFont_textfield, 0);


HFONT m_hFont = NULL;
HFONT m_hFont_textfield = NULL;
...
class SG_InputBox
{
	...
	static HFONT m_hFont_textfield;
